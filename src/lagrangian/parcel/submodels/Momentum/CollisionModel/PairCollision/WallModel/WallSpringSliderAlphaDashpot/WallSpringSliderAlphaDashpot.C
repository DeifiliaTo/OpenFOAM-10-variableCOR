...
#include "WallSpringSliderAlphaDashpot.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class CloudType>
void Foam::WallSpringSliderAlphaDashpot<CloudType>::findMinMaxProperties
(
    scalar& rMin,
    scalar& rhoMax,
    scalar& UMagMax
...
template<class CloudType>
void Foam::WallSpringSliderAlphaDashpot<CloudType>::evaluateWall
(
...
template<class CloudType>
Foam::scalar Foam::WallSpringSliderAlphaDashpot<CloudType>::pREff
(
...
template<class CloudType>
bool Foam::WallSpringSliderAlphaDashpot<CloudType>::controlsTimestep() const
{
    return true;
}
...
template<class CloudType>
Foam::label Foam::WallSpringSliderAlphaDashpot<CloudType>::nSubCycles() const
{
    if (!(this->owner().size()))
    {
        return 1;
