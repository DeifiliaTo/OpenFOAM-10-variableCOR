...
{
    defineTypeNameAndDebug(generalAlpha, 0);
    addToRunTimeSelectionTable(distributionModel, generalAlpha, dictionary);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::distributionModels::generalAlpha::generalAlpha
(
...
:
    ...
    alphaDependencyFile_(this->distributionModelDict_.lookup("alphaDependencyFile"))
{
    check();
...
Foam::distributionModels::generalAlpha::generalAlpha(const generalAlpha& p)
:
    distributionModel(p),
    xy_(p.xy_),
...
Foam::scalar Foam::distributionModels::generalAlpha::sample() const
{
...
Foam::scalar Foam::distributionModels::generalAlpha::minValue() const
{
    return minValue_;
}


Foam::scalar Foam::distributionModels::generalAlpha::maxValue() const
{
    return maxValue_;
}


Foam::scalar Foam::distributionModels::generalAlpha::meanValue() const
{
    return meanValue_;
}
