...
Foam::scalar Foam::alphaModels::fixedValue::fixedValue::sample() const
{
    return value_;
}


Foam::scalar Foam::alphaModels::fixedValue::fixedValue::minValue() const
{
    return value_;
}


Foam::scalar Foam::alphaModels::fixedValue::fixedValue::maxValue() const
{
    return value_;
}


Foam::scalar Foam::alphaModels::fixedValue::fixedValue::meanValue() const
{
    return value_;
}
